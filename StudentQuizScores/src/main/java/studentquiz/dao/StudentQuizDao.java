...
public interface StudentQuizDao {
    ...
    int getAvgQuizScores(String studentId);
    ArrayList<Integer> getStudentScores(String studentId);
    Map<String, ArrayList<Integer>> enterQuizScore(StudentQuizScores newStudentQuiz);
}
